            ...
            <div class="col-9 container-fluid justify-content-lg-end">
              <div class="container-fluid col d-flex justify-content-lg-end" style="margin-left: 70px">
                  <li class="nav-item dropdown d-flex">
                      ...
                      <a href="#" class="nav-link text-reset my-auto" id="navbarDropdownMenuLink"
                      role="button" data-bs-toggle="dropdown" aria-expanded="false"><img src="{{ asset('assets/img/down-arrow.svg') }}" id="navbarDropdownMenuLink" alt="arrow" width="20px"></a>
