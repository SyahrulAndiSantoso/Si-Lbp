        ...
        <div class="col-lg-6 col-md-12 col-sm-12 col-12 mt-md-3 mt-5 d-none d-md-block">
            <div class="d-md-flex justify-content-end landing-page">
                <div class="text-white icon-landing-page">
                    <img src="{{ asset('assets/img/landing-page.png') }}" alt="landing-page" class="mt-4" style="width: 100%;">
                </div>
            </div>
        </div>
    </div>
...
<img src="{{ asset('assets/img/ball-1.png') }}" alt="ball1" class="position-absolute top-0 start-0" width="82px" style="margin-top: 220px; margin-left: 65px; opacity: 0.2;">

<img src="{{ asset('assets/img/bg3.png') }}" alt="bg3" class="position-absolute top-0 end-0 d-none d-md-block" width="90px" style="margin-top: 80px; margin-right: 126px;">

<img src="{{ asset('assets/img/bg2.png') }}" alt="bg2" class="position-absolute top-0 end-0 d-none d-md-block" width="126px" style="margin-top: 80px;">

<div class="position-absolute bottom-0 end-0 h-25 d-none d-md-block" style="width: 101px; border-top-left-radius: 50px; background-color: #E5F0FC;"></div>

<img src="{{ asset('assets/img/ball-2.png') }}" alt="ball2" class="position-absolute bottom-0 start-50 translate-middle-x d-none d-md-block" width="119px">
</div>
