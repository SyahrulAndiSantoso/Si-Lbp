            ...
            <div class="row">
              ...
              <div class="col-12 col-md-6">
                <div class="px-5 pt-5 mt-5">
                  ...
                  <form action="/forgot-password-store" method="POST">
                    @csrf
                    <div class="mb-3 mt-4">
                      <label for="" class="mb-2">Email Address</label>
                      <input type="text" class="form-control w-75" name="email" placeholder="Enter Email">
                    </div>
                        <button type="submit" name="submit" class="btn btn-primary w-75 fs-14 fw-bold rounded-5" style="background: #FF7979 ;">Send Instruction</button>
                  </form>
                </div>
              </div>
            </div>
