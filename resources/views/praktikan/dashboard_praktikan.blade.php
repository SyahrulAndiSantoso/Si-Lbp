          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-6 fs-16 px-3 mt-2" style="line-height: 10px;">
                ...
                <a href="/materi-praktikum/{{$percentage['PT']->latihan_id}}/{{$percentage['PT']->materi_id}}"
                  class="btn fw-bold fs-14 mt-2" style="background-color: #77B5F2 ;">Continue ></a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-6 fs-16 px-3 mt-2" style="line-height: 10px;">
                ...
                <a href="/materi-praktikum/{{$percentage['SD']->latihan_id}}/{{$percentage['SD']->materi_id}}"
                  class="btn fw-bold fs-14 mt-2" style="background-color: #77B5F2 ;">Continue ></a>
              </div>
            </div>
          </div>
